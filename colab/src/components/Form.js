...
import { postAllUsers } from "../service/Service";
...
class Form extends Component {
  ...
  validateField = (name, value, refValue) => {
    ...
    switch (name) {
      case "name":
        ...
        break;
      case "photo":
        if (!value) errorMsg = "Please enter image path..";
        break;
      case "email":
  ...
  handleSubmit = async () => {
    ...
    form["id"] = Math.round(Math.random() * 1000);
    await postAllUsers(form);
  };
          ...
          <div className="row">
            <div className="col-md-6">
              ...
              <div className="form-group">
                ...
                />
                {formErrors.photo && (
                  <span className="err">{formErrors.photo}</span>
                )}
              </div>
              <div className="form-group">
                <label>
            ...
            <button type="submit" disabled="false" className="btn btn-primary">Submit</button>
          </div>
            </div>
          </div>
